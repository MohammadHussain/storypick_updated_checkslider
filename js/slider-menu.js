...
jssor_slider2_starter = function (containerId) {
    var options = {
        ...
        $SlideWidth: 235,                                   //[Optional] Width of every slide in pixels, default value is width of 'slides' container
...
jssor_slider3_starter = function (containerId) {
    ...
    $Jssor$.$AddEvent(window, "resize", $Jssor$.$WindowResizeFilter(window, ScaleSlider3));
    $Jssor$.$AddEvent(window, "orientationchange", ScaleSlider2);
    ////responsive code end
};

jssor_slider2_starter('slider3_container');